...
Defined in: [packages/oidc/src/get-vercel-oidc-token-sync.ts:24](https://github.com/AbhilashG12/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-sync.ts#L24)
