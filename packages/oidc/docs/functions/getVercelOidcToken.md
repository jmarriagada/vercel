...
Defined in: [packages/oidc/src/get-vercel-oidc-token-with-refresh.ts:64](https://github.com/AbhilashG12/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-with-refresh.ts#L64)
